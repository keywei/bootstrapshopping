...
if(isset($_POST["action"])&&($_POST["action"]=="join")){
	...
	if ($row){
		header("Location: member_join.php?errMsg=1&username={$_POST["m_email"]}");
	}else{
	//若沒有執行新增的動作
...
<table width="780" border="0" align="center" cellpadding="4" cellspacing="0">
  <tr>
    <td class="tdbline"><img src="images/Welcome.jpg" alt="會員系統" width="164" height="67"></td>
  </tr>
  <tr>
  ...
  <tr>
    <td align="center" background="images/album_r2_c1.jpg" class="trademark">© 2020 eHappy Studio All Rights Reserved.</td>
  </tr>
</table>
</body>
</html>